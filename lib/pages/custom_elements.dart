  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
          ...
          child: Row(
            children: [
              CustomAvatar(
                avatarRadius: 40,
                borderThick: 5,
                photoIndex: widget.photoIndex % 10,
              ),
              const SizedBox(
                width: 5,
              ),
        ...
        widget.useHero
            ? Hero(
                tag: 'assets/img/profile_avatar (${widget.photoIndex + 1}).jpg',
                child: Image.asset(
                    'assets/img/profile_avatar (${widget.photoIndex % 10 + 1}).jpg'),
              )
            : Image.asset(
                'assets/img/profile_avatar (${widget.photoIndex % 10 + 1}).jpg'),
        Padding(
                  ...
                  Row(
                    children: [
                      InkWell(
                        onTap: () {
                          setState(() {
                            likedState ? likedState = false : likedState = true;
                          });
                        },
                        child: Icon(
                          Icons.thumb_up,
                          size: 35,
                          color: likedState ? Colors.red : null,
                        ),
                      ),
                      const Padding(
